...
// Safety: only run E2E tests when a dedicated TEST Supabase project is explicitly configured.
// This avoids accidentally creating test data in production projects.
