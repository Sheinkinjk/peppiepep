  ...
  return (
    <ConsumerShell>
      ...
      <main className="mx-auto max-w-3xl px-5 py-10 sm:px-8 sm:py-14">
        ...
        {/* Trust strip */}
        <div className="mt-6 grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-[#ded8cd] bg-[#ded8cd] sm:grid-cols-3">
        ...
        <section className="mt-14">
          <h2 className="text-2xl font-bold tracking-tight text-[#14120f]">The offer at a glance</h2>
          <div className="mt-5">
