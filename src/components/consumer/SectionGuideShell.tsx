  ...
  return (
    <ConsumerShell>
      ...
      <main id="main-content" className="mx-auto max-w-3xl px-5 pb-20 pt-10 sm:px-8">
        ...
        <p className="mt-5 text-lg leading-relaxed text-[#14120f]">{intro}</p>
        ...
        <p className="mt-4 text-xs font-medium text-[#56504a]">
        ...
        <section className="mt-12 border-t border-[#f1ede4] pt-8">
          ...
          <ul className="mt-3 flex flex-wrap gap-x-5 gap-y-2 text-sm">
            {related.map((r) => (
              <li key={r.href}>
                <Link href={r.href} className="font-semibold text-[#007a95] hover:underline">{r.label}</Link>
              </li>
            ))}
            <li>
              <Link href={sectionHref} className="text-[#56504a] hover:text-[#007a95] hover:underline">
