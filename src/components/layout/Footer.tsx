...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden">
      {/* CTA Strip - Hero gradient */}
      <div className="relative bg-gradient-to-r from-[#024b56] via-[#03616e] to-[#047a87]">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(87,230,255,0.12),transparent_50%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,rgba(10,167,181,0.08),transparent_50%)]" />
        </div>
        <div className="relative mx-auto max-w-6xl px-6 sm:px-8 lg:px-12 py-12 sm:py-16">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-7 py-3.5 text-sm font-bold text-[#024b56] transition-all hover:-translate-y-0.5 hover:bg-white/90 shadow-lg shadow-black/10 whitespace-nowrap"
            >
