...
const softwareSchema = {
  ...
  offers: { "@type": "Offer", priceCurrency: "USD", description: "Free plan (up to 20 responses/month, no card); paid plans from around US$17/month.", availability: "https://schema.org/InStock" },
