...
export const leadpagesConfig: AffiliatePageConfig = {
  ...
  atAGlance: [
    ...
    { k: "Price", v: "Free trial; paid plans (verify current pricing)" },
  ],
  trustStrip: [
