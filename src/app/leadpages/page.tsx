...
const webPageSchema = {
  ...
  dateModified: pageDates("/leadpages")?.updated ?? "2026-07-08",
    ...
    <>
      ...
      <div className="border-t border-[#ded8cd] bg-white py-6">
        <div className="mx-auto max-w-3xl px-6 sm:px-8">
          ...
          <Link href="/best-website-builder" className="text-sm text-[#007a95] font-semibold hover:text-[#003647] transition-colors">
