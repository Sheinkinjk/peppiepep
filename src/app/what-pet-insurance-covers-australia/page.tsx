      ...
      <main className="text-[#14120f]">
        <div className="mx-auto max-w-3xl px-6 sm:px-8">
          ...
          <section className="mb-12 space-y-6">
            {SECTIONS.map((s) => (
              <div key={s.h} className="border-t border-[#ded8cd] pt-6">
                <h2 className="text-xl font-bold tracking-[-0.01em] text-[#14120f]">{s.h}</h2>
                <p className="mt-2 text-[15px] leading-relaxed text-[#56504a]">{s.p}</p>
              </div>
            ))}
          </section>

          <section className="mb-12">
            <h2 className="text-xl font-bold tracking-[-0.01em] text-[#14120f]">Common questions</h2>
          ...
          <section className="mb-14 rounded-2xl border border-[#b9e3eb] bg-[#e4f2f5] p-6">
            <h2 className="text-lg font-extrabold text-[#14120f]">The one thing to do before buying</h2>
            ...
            <Link href="/pet-insurance" className="mt-5 inline-flex items-center gap-1 text-sm font-semibold text-[#007a95] hover:text-[#003647]">
