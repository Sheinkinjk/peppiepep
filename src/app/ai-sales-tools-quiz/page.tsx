      ...
      <main className="text-[#14120f]">
        <div className="mx-auto max-w-3xl px-6 sm:px-8 lg:px-12">
          <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-2 pt-8 text-sm text-[#56504a]">
            ...
            <Link href="/best-ai-sales-tools" className="transition-colors hover:text-[#007a95]">AI sales tools</Link>
            <span aria-hidden="true">/</span>
            <span className="text-[#14120f]">Which tool do you need</span>
          ...
          <section className="mt-8 border-t border-[#ded8cd] py-9">
            ...
            <div className="max-w-2xl space-y-4 text-[15px] leading-relaxed text-[#56504a]">
              <p>
                ...
                <Link href="/best-ai-sales-tools" className="text-[#007a95] underline underline-offset-2">full AI sales-tools roundup</Link>{" "}
                lays out all four side by side, and the{" "}
                <Link href="/compare/ai-sales-tools" className="text-[#007a95] underline underline-offset-2">category hub</Link>{" "}
