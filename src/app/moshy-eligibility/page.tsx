    ...
    <ConsumerShell>
      ...
      <main id="main-content" className="relative mx-auto max-w-3xl px-5 sm:px-8 lg:px-12 pb-24 pt-12 sm:pt-16">
        ...
        <p className="mb-10 rounded-lg border border-[#ded8cd] bg-[#f7f4ee] px-4 py-3 text-xs leading-relaxed text-[#56504a]">
          <span className="font-semibold text-[#14120f]">Information only.</span> This page explains a sign-up process.
          ...
          <ol className="space-y-4">
            {[
              ...
              <li key={h} className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-[#14120f] text-sm sm:text-base">{h}</p>
                  <p className="text-[#56504a] text-sm leading-relaxed mt-1">{b}</p>
                </div>
              </li>
            ))}
          </ol>
