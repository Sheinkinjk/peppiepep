      ...
      <main className="text-white">
        <div className="mx-auto max-w-4xl px-6 sm:px-8 lg:px-12">
          ...
          <nav className="flex flex-wrap items-center gap-2 pt-8 text-sm text-white/55">
            ...
            <span>/</span>
            <span className="text-white/70">Best Weight Loss Telehealth</span>
          </nav>
              ...
              <table className="w-full min-w-[540px] text-sm">
                <thead>
                  <tr className="border-b border-white/[0.08]">
                    ...
                    <th className="pb-3 px-3 text-left text-white/40 font-semibold text-[11px] uppercase tracking-wider">Who it&apos;s for</th>
                    <th className="pb-3 px-3 text-left text-white/40 font-semibold text-[11px] uppercase tracking-wider">Approach</th>
                    <th className="pb-3 px-3 text-left text-white/40 font-semibold text-[11px] uppercase tracking-wider">GLP-1 access</th>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={row.name} className="border-b border-white/[0.08] hover:bg-white/[0.03] transition-colors">
                      ...
                      <td className="py-3 px-3 text-white/55 text-xs">{row.audience}</td>
                      <td className="py-3 px-3 text-white/55 text-xs">{row.approach}</td>
