    ...
    <ConsumerShell>
      ...
      <main id="main-content" className="relative mx-auto max-w-3xl px-5 sm:px-8 lg:px-12 pb-24 pt-12 sm:pt-16">
        ...
        <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm text-white/55">
          ...
          <span>/</span>
          <span className="text-white/70">Moshy vs Juniper</span>
        </nav>

        {/* Hero */}
        <p className="text-white/40 text-xs mb-5">Updated June 2026 · Australia · Not medical advice</p>
        ...
        <p className="text-white/55 text-base sm:text-lg leading-relaxed mb-6 max-w-2xl">
          ...
          people. The short version: <strong className="text-white/70">Moshy is for men, Juniper is for women</strong> — and the
          difference goes deeper than that.
        </p>
        <p className="mb-8 rounded-lg border border-white/[0.08] bg-white/[0.03] px-4 py-3 text-xs leading-relaxed text-white/55">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-6">
            ...
            <p className="mt-3">
              <Link href="/moshy" className="text-xs text-white/55 underline decoration-white/20 underline-offset-2 hover:text-white/70">
                Read our full Moshy review →
              </Link>
            </p>
          </div>
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-6">
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] mb-2 text-white/55">For women</p>
