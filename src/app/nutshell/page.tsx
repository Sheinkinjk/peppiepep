...
const softwareSchema = {
  ...
  offers: { "@type": "Offer", priceCurrency: "USD", description: "14-day free trial, no card; per-user plans from around $13/user/month.", availability: "https://schema.org/InStock" },
