      ...
      <main id="main-content">
        <section className="mx-auto max-w-4xl px-5 pt-10 sm:px-8 sm:pt-14">
          ...
          <p className="mt-8 max-w-3xl rounded-xl border border-[#ded8cd] bg-[#f7f4ee] px-5 py-4 text-xs leading-relaxed text-[#56504a]">
            <span className="font-semibold text-[#14120f]">A note on the numbers.</span> Commission rates, recurring
            ...
            <table className="w-full min-w-[680px] text-sm">
              <thead>
                <tr className="border-b border-[#ded8cd] bg-[#f7f4ee]">
                  ...
                  <th className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-[#56504a]">Category</th>
                  <th className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-[#56504a]">Typical recurring commission</th>
              ...
              <tbody>
                {programs.map((p) => (
                  <tr key={p.name} className="border-b border-[#f1ede4] last:border-0 hover:bg-[#f7f4ee]">
                    <td className="px-5 py-4 font-bold text-[#14120f]">
                      {p.href ? <Link href={p.href} className="nw-link">{p.name}</Link> : p.name}
                    </td>
                    <td className="px-4 py-4 text-[#56504a]">{p.category}</td>
