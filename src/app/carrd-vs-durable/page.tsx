    ...
    <ConsumerShell>
      ...
      <main id="main-content" className="relative mx-auto max-w-3xl px-5 sm:px-8 lg:px-12 pb-24 pt-12 sm:pt-16">
        ...
        <div className="rounded-xl border px-6 py-5 mb-10" style={{ borderColor: `${CYAN}40`, background: `${CYAN}0A` }}>
          ...
          <p className="text-[#14120f] text-sm sm:text-base leading-relaxed mb-5">
            Want one clean page for the least money? <strong className="text-[#14120f]">Carrd.</strong> Want a full,
            multi-page business site generated by AI, with a CRM and invoicing built in? <strong className="text-[#14120f]">Durable AI.</strong>
          </p>
          <div className="flex flex-wrap gap-3">
            ...
            <a {...aff(DURABLE_URL)} data-cta="verdict-durable" className="inline-flex items-center gap-2 rounded-xl border px-5 py-2.5 text-sm font-semibold text-[#14120f] transition-all hover:text-[#14120f]" style={{ borderColor: `${CYAN}40` }}>
          ...
          <table className="w-full min-w-[560px] text-sm">
            <thead>
              <tr className="bg-[#f7f4ee]">
                ...
                <th className="text-left font-black text-[#14120f] px-4 py-3">Carrd</th>
                <th className="text-left font-black text-[#14120f] px-4 py-3">Durable AI</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((r) => (
                <tr key={r.label} className="border-t border-[#ded8cd] align-top">
                  ...
                  <td className="px-4 py-3 text-[#14120f]">{r.carrd}</td>
                  <td className="px-4 py-3 text-[#14120f]">{r.durable}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="rounded-xl border border-[#ded8cd] bg-[#f7f4ee] p-6">
            ...
            <p className="mt-3"><Link href="/carrd" className="text-xs text-[#56504a] underline decoration-[#ded8cd] underline-offset-2 hover:text-[#14120f]">Read our Carrd review →</Link></p>
          </div>
          <div className="rounded-xl border border-[#ded8cd] bg-[#f7f4ee] p-6">
