...
export default function PaymentError({
  ...
  useEffect(() => {
    ...
    console.error('Payment page error caught:', error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-red-50 via-white to-white px-4">
      <Card className="max-w-md w-full p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          We encountered an issue loading the payment information. Don't worry - no charges have been made.
        </p>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6">
          ...
          <p className="text-sm text-blue-800">
            If you initiated a payment and see this error, please contact support to verify your payment status before trying again.
          </p>
        </div>
