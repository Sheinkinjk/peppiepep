  ...
  return (
    <ConsumerShell>
      ...
      <main id="main-content" className="mx-auto max-w-3xl px-5 pb-20 pt-10 sm:px-8">
            ...
            <section key={hub} className="mt-12">
              ...
              {groupBySubject(inHub).map(([subject, facts]) => (
                <div key={subject} className="mt-6">
                  <h3 className="text-[15px] font-bold text-[#14120f]">{subject}</h3>
        ...
        <section className="mt-14 border-t border-[#ded8cd] pt-10">
          <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">Using this data</h2>
          <p className="mt-4 text-[15px] leading-relaxed text-[#56504a]">
            The whole log is available as a spreadsheet:{' '}
            <a href="/data/observations.csv" className="font-semibold text-[#007a95] underline-offset-2 hover:underline">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-[#56504a]">
            ...
            <a href="mailto:jarred@referlabs.com.au" className="text-[#007a95] underline-offset-2 hover:underline">
