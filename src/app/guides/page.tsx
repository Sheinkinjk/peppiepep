...
const hubs = [
  ...
  { href: "/skin-and-beauty/foreo-luna-vs-ufo", label: "Foreo Luna vs UFO", desc: "Two different device lines, not two versions of one. Australian list prices for both." },
  { href: "/skin-and-beauty/natural-skincare-australia", label: "Natural vs Certified Organic Skincare", desc: "Only one of those two words can be checked in a public register. How to run the check." },
