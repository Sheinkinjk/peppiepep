...
const hubs = [
  ...
  { href: "/longevity/diagnostics/whole-body-mri-australia-cost", label: "Whole-Body MRI: Cost and Criticism", desc: "Why there is no rebate, and what an incidental finding costs you." },
  ...
  { href: "/mens-health/online-doctor-medical-certificate-australia", label: "Online Medical Certificate Cost", desc: "What one costs, how fast it arrives, and when a telehealth certificate is the wrong choice." },
  { href: "/mens-health/online-prescription-australia", label: "Online Prescriptions in Australia", desc: "New versus repeat pricing, how an eScript reaches you, and the identifier you need before you pay." },
  ...
  { href: "/aussie-health-products", label: "Aussie Health Products", desc: "A marketplace of 300+ brands, and what a shop does not decide." },
  { href: "/health-and-beauty/retinol-vs-prescription-strength-australia", label: "Retinol vs Prescription-Strength", desc: "What separates them, and how each is accessed in Australia." },
  { href: "/health-and-beauty/led-face-mask-comparison-australia", label: "LED Face Masks in Australia", desc: "Verified AUD prices, the US price gap, and checking the ARTG." },
  ...
  { href: "/compare/ai-tools", label: "AI Tools", desc: "AI assistants and voice, sorted by what they do." },
...
const sections = [
  ...
  },
  {
    ...
    guides: [
      ...
      { href: "/portable-power-station-australia", label: "Portable Power Stations", desc: "Verified AUD prices across both ranges, priced per watt-hour, and what each size runs." },
      { href: "/ecoflow-vs-anker-solix", label: "EcoFlow vs Anker SOLIX", desc: "The two ranges at matching capacities, and which is cheaper per watt-hour." },
      { href: "/ecoflow", label: "EcoFlow Australia", desc: "The range from A$299 to A$7,299, and where the discounts are." },
      { href: "/anker-solix", label: "Anker SOLIX Australia", desc: "The range from A$449 to A$5,399, and where the extra output is worth paying for." },
      { href: "/portable-vs-installed-home-battery-australia", label: "Portable vs Installed", desc: "Which one the federal rebate applies to, and which suits renters." },
      ...
      { href: "/best-home-battery-australia", label: "Best Home Battery", desc: "How to choose one: capacity, chemistry, warranty, and why the installer matters." },
      ...
      { href: "/home-battery-blackout-backup-australia", label: "Blackout Backup", desc: "Not every battery keeps the power on in an outage. What backup needs." }
    ],
  },
  {
    ...
    <ConsumerShell>
      ...
      <main id="main-content" className="mx-auto max-w-6xl px-5 pb-20 pt-12 sm:px-8 sm:pt-16">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2">
          {hubs.map((h) => (
            <Link key={h.href} href={h.href} className="group rounded-2xl border border-[#007a95]/25 bg-[#f7f4ee] p-6 transition-all hover:-translate-y-0.5 hover:shadow-[0_10px_30px_-16px_rgba(0,0,0,0.25)]">
              <div className="flex items-center justify-between">
                <ArrowRight className="h-4 w-4 text-[#007a95] transition-transform group-hover:translate-x-0.5" />
              </div>
              <h2 className="mt-3 text-xl font-bold text-[#14120f] group-hover:text-[#007a95]">{h.label}</h2>
        ...
        <div className="mt-6 space-y-0">
          {sections.map((section) => (
            <section key={section.label} className="border-t border-[#ded8cd] py-12">
              <div className="grid gap-8 lg:grid-cols-[220px_1fr] lg:gap-14">
                <div className="lg:pt-1">
                  <h2 className="text-xl font-bold text-[#14120f]">{section.label}</h2>
                  <p className="mt-2 text-[13px] leading-relaxed text-[#56504a]">{section.description}</p>
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
                  {section.guides.map((guide) => (
                    <Link key={guide.href} href={guide.href} className="group rounded-xl border border-[#ded8cd] bg-[#f7f4ee] p-5 transition-all hover:-translate-y-0.5 hover:border-[#007a95]/40">
                      <h3 className="text-[15px] font-bold text-[#14120f] group-hover:text-[#007a95]">{guide.label}</h3>
                      <p className="mt-1.5 text-sm leading-relaxed text-[#56504a]">{guide.desc}</p>
                    </Link>
                  ))}
                </div>
              </div>
        ...
        <div className="border-t border-[#ded8cd] pt-10">
