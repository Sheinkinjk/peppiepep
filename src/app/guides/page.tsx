...
const hubs = [
  ...
  { href: "/portable-power-station-australia", label: "Portable Power", desc: "What a portable power station costs in Australia, and what each size actually runs." },
...
const sections = [
  ...
  },
  {
    ...
    guides: [
      ...
      { href: "/ecoflow", label: "EcoFlow Australia", desc: "The range from A$299 to A$7,299, and where the discounts actually are." },
