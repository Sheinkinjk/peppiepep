    ...
    <ConsumerShell>
      ...
      <main id="main-content" className="relative mx-auto max-w-3xl px-5 sm:px-8 lg:px-12 pb-24 pt-12 sm:pt-16">
        <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm text-[#6B756F]">
          ...
          <span>/</span>
          <span className="text-[#46524C]">Moshy vs GP</span>
        </nav>
        ...
        <p className="mb-10 rounded-lg border border-black/[0.08] bg-white px-4 py-3 text-xs leading-relaxed text-[#6B756F]">
          <span className="font-semibold text-[#46524C]">Information only.</span> This page compares two ways of
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-white">
                  ...
                  <th className="text-left font-black text-[#16201C] px-4 py-3">Your GP</th>
                </tr>
              </thead>
              <tbody>
                {rows.map(([k, m, g]) => (
                  <tr key={k} className="border-t border-black/[0.08] align-top">
                    <td className="px-4 py-3 text-[#6B756F] font-medium">{k}</td>
                    <td className="px-4 py-3 text-[#46524C]">{m}</td>
                    <td className="px-4 py-3 text-[#46524C]">{g}</td>
                  </tr>
                ))}
              </tbody>
            </table>
