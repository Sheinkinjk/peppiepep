...
const webPageSchema = {
  ...
  dateModified: pageDates("/weight-loss-quiz")?.updated ?? "2026-07-08",
      ...
      <main className="text-[#14120f]">
        <div className="mx-auto max-w-3xl px-6 sm:px-8 lg:px-12">
          <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-2 pt-8 text-sm text-[#56504a]">
            ...
            <Link href="/weight-loss" className="transition-colors hover:text-[#007a95]">Weight loss</Link>
            <span aria-hidden="true">/</span>
          ...
          <section className="mt-8 border-t border-[#ded8cd] py-9">
            ...
            <div className="max-w-2xl space-y-4 text-[15px] leading-relaxed text-[#56504a]">
              <p>
                ...
                <Link href="/weight-loss" className="text-[#007a95] underline underline-offset-2">weight-loss hub</Link>{" "}
                covers how telehealth works, what it costs and what to watch for, and the{" "}
                <Link href="/weight-loss-cost-calculator" className="text-[#007a95] underline underline-offset-2">cost calculator</Link>{" "}
