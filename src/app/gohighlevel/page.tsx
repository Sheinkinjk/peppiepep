...
const softwareSchema = {
  ...
  offers: {
    ...
    price: "97",
    priceCurrency: "USD",
    description: "Starter from around $97/month at the time of writing; Unlimited from around $297/month. 14-day free trial, no credit card. Verify current pricing on the provider.",
