...
export default function ReferralPageError({
  ...
  useEffect(() => {
    ...
    console.error('Referral page error caught:', error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-red-50 via-white to-white px-4">
      <Card className="max-w-md w-full p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          We couldn't load this referral page. The link might be invalid or there may be a temporary issue.
        </p>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6 text-left">
          ...
          <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
            <li>Double-check the referral link you received</li>
            <li>Contact the person who referred you</li>
            <li>Try refreshing the page</li>
            <li>Visit our main site to learn more</li>
          </ul>
        </div>
