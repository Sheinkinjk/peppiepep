        ...
        <div className="mx-auto max-w-4xl px-6 sm:px-8 lg:px-12">
          ...
          <section className="pb-2">
            <h2 className="text-xl sm:text-2xl font-extrabold tracking-tight text-[#14120f] mb-4">
              Mosh or Dense: which should you choose for hair loss?
            </h2>
              ...
              <table className="w-full min-w-[560px] text-sm">
                <thead>
                  <tr className="border-b border-[#ded8cd]">
                    ...
                    <th className="pb-3 px-3 text-left font-extrabold text-[#14120f] text-sm">Mosh</th>
                    <th className="pb-3 px-3 text-left font-extrabold text-[#14120f] text-sm">Dense</th>
                  </tr>
                </thead>
                <tbody>
                  {rows.map((r) => (
                    <tr key={r.label} className="border-b border-[#ded8cd] hover:bg-[#f7f4ee] transition-colors align-top">
                      ...
                      <td className="py-3 px-3 text-[#56504a] text-xs leading-snug">{r.mosh}</td>
                      <td className="py-3 px-3 text-[#56504a] text-xs leading-snug">{r.dense}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section className="border-t border-[#ded8cd] py-10">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="rounded-xl border border-[#ded8cd] bg-[#f7f4ee] p-6">
                ...
                <p className="mt-3"><Link href="/dense" className="text-xs text-[#56504a] underline decoration-[#ded8cd] underline-offset-2 hover:text-[#14120f]">Read our Dense review →</Link></p>
              </div>
            </div>
          </section>
