...
const services = [
  ...
  },
  {
    ...
    copy: "We identify aligned operators, consultants, and influencers who can represent your brand authentically. We structure partnerships that turn audiences into distribution channels with clear commercial terms.",
    bullets: [
      ...
      <main id="main-content" className="relative mx-auto max-w-5xl px-6 sm:px-8 lg:px-12 pb-24 pt-16 sm:pt-20">
        ...
        <div className="mb-16 sm:mb-20">
          ...
          <p className="text-white/55 text-base sm:text-lg leading-relaxed max-w-2xl mb-8">
            Refer Labs builds and activates scalable distribution systems. We structure the entire growth engine end-to-end, from launch through to scale.
          </p>
          <a
            href={calendlyUrl}
            target="_blank"
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div>
                ...
                {service.note && (
                  <p className="text-white/30 text-xs italic mb-5">{service.note}</p>
                )}
                <a
                  href={calendlyUrl}
                  target="_blank"
        ...
        {/* Final CTA */}
        <div className="border-t border-white/[0.07] pt-16 sm:pt-20 text-center">
