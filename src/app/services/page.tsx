        ...
        <div className="mx-auto max-w-3xl px-5 sm:px-8 lg:px-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#0AA7B5] px-8 py-4 text-sm font-bold text-white transition-all hover:-translate-y-0.5 hover:bg-[#00838F] shadow-lg shadow-[#0AA7B5]/25"
            >
            ...
            <Link
              href="/pricing"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-8 py-4 text-sm font-semibold text-slate-900 transition-all hover:bg-slate-50 hover:shadow-md"
            >
              View Pricing
              <ArrowRight className="h-4 w-4" />
            </Link>
