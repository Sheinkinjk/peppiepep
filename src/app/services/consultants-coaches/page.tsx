...
const content = {
  ...
  heroSubtitle:
    "Your best clients came from word-of-mouth. Refer Labs helps you turn informal introductions into a systematic referral engine—activating LinkedIn influencers, agency partners, and happy clients to send you high-value engagements.",
  ...
  ctaDescription:
    "Book a free 30-minute call. We'll show you how to activate your network, set up tracking, and launch a referral program that fills your calendar with qualified prospects.",
};
