...
export default function Page() {
  return (
    ...
    >
      <section>
        <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">The routes, and who arranges them</h2>
      ...
      <section>
        <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">The Mental Health Treatment Plan is the underused part</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">What an online clinic is good at</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">Before you subscribe to anything</h2>
