...
export default function Page() {
  return (
    ...
    >
      <section>
        <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">The identifier is what decides it</h2>
        <div className="mt-4 rounded-2xl border border-[#007a95]/25 bg-[#f7f4ee] p-6">
          <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-[#007a95]">Before you pay</p>
          <p className="mt-2 text-[15px] font-semibold leading-relaxed text-[#14120f]">
      ...
      <section>
        <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">What each request type costs</h2>
          ...
          <table className="w-full min-w-[560px] border-collapse text-left text-sm">
            ...
            <tbody className="divide-y divide-[#f1ede4]">
              {REQUEST_TYPES.map(([name, price, what]) => (
                <tr key={name}>
                  <td className="px-4 py-3 font-semibold text-[#14120f]">{name}</td>
      ...
      <section>
        <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">A request is not a prescription</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">How long does an online prescription take?</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-bold tracking-[-0.01em] text-[#14120f]">When to use your GP instead</h2>
