    ...
    <ConsumerShell>
      ...
      <main id="main-content" className="relative mx-auto max-w-3xl px-5 sm:px-8 lg:px-12 pb-24 pt-12 sm:pt-16">
        ...
        <p className="mb-10 rounded-lg border border-[#ded8cd] bg-[#f7f4ee] px-4 py-3 text-xs leading-relaxed text-[#56504a]">
          <span className="font-semibold text-[#14120f]">Information only.</span> Eligibility for any medical
        ...
        <div className="rounded-2xl border px-6 py-7 mb-10 text-center sm:px-8" style={{ borderColor: `${CYAN}30`, background: `${CYAN}08` }}>
          <h2 className="text-lg sm:text-xl font-black text-[#14120f]">Find out if you qualify</h2>
          ...
          <div className="mt-5 flex flex-wrap justify-center gap-3">
            ...
            <Link href="/weight-loss-quiz" className="inline-flex items-center gap-2 rounded-xl border border-[#ded8cd] bg-white px-6 py-3 text-sm font-bold text-[#14120f] hover:bg-[#f7f4ee] transition-colors">
