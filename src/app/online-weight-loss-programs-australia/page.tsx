    ...
    <ConsumerShell>
      ...
      <main id="main-content" className="relative mx-auto max-w-3xl px-5 sm:px-8 lg:px-12 pb-24 pt-12 sm:pt-16">
        <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm text-white/55">
          ...
          <span>/</span>
          <span className="text-white/70">Online Weight Loss Programs</span>
        </nav>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-white/[0.03]">
                  <th className="text-left font-semibold text-white/55 px-4 py-3">Provider</th>
                  <th className="text-left font-semibold text-white/55 px-4 py-3">Built for</th>
                  <th className="text-left font-semibold text-white/55 px-4 py-3">Approach</th>
                </tr>
              </thead>
              <tbody>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          ...
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-6">
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] mb-2 text-white/55">Other paths</p>
