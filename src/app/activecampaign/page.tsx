...
const softwareSchema = {
  ...
  offers: { "@type": "Offer", priceCurrency: "USD", description: "14-day free trial, no card; plans from around US$15/month for 1,000 contacts billed annually.", availability: "https://schema.org/InStock" },
