      ...
      <main className="bg-[#060f15] text-white min-h-screen">
        <div className="mx-auto max-w-4xl px-6 sm:px-8 lg:px-12">
          ...
          <nav className="flex flex-wrap items-center gap-2 pt-8 text-sm text-white/40">
            ...
            <span>/</span>
            <span className="text-white/60">Best Peptide Supplier</span>
          </nav>

          {/* ── Hero ─────────────────────────────────────────────────────────── */}
          <section className="pt-10 pb-8 sm:pt-12">
            <p className="text-white/25 text-xs mb-6">Updated March 2026 &middot; For laboratory research use only</p>
              ...
              <table className="w-full min-w-[560px] text-sm">
                <thead>
                  <tr className="border-b border-white/[0.07]">
                    <th className="text-left pb-3 pr-4 text-white/20 font-semibold text-[11px] uppercase tracking-wider w-44">Supplier</th>
                    <th className="pb-3 px-3 text-left text-white/20 font-semibold text-[11px] uppercase tracking-wider">Best for</th>
                    <th className="pb-3 px-3 text-left text-white/20 font-semibold text-[11px] uppercase tracking-wider">Discount / Offer</th>
              ...
              <table className="w-full min-w-[520px] text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-t border-white/[0.07]">
                    <td className="py-3.5 pr-4 text-white/40 text-xs font-semibold">Current deal</td>
                    {[
                      "Referral link",
                      "Referral link",
                      "Frequent sale",
