...
function Offer({ loc }: { loc: string }) {
  return (
    <div className="rounded-2xl border border-[#b9e3eb] bg-[#e4f2f5] p-6">
      <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-[#003647]">The offer</p>
      <p className="mt-2 text-lg font-bold leading-snug text-[#14120f]">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3">
        ...
        <Link href="/apollo-energy-group" className="text-sm font-semibold text-[#007a95] hover:underline">
      ...
      <ConsumerShell>
        <main id="main-content" className="mx-auto max-w-3xl px-5 pb-24 pt-12 sm:px-8 sm:pt-16">
          ...
          <section className="mt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">Which home battery systems qualify for the Australian government rebate?</h2>
            <div className="mt-4 rounded-2xl border border-[#b9e3eb] bg-[#e4f2f5] px-6 py-5">
          ...
          {/* What it is */}
          <section className="mt-12 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">What the rebate is</h2>
            <div className="mt-4 space-y-4 text-[15.5px] leading-relaxed text-[#56504a]">
              <p>
                It is called the <strong className="font-semibold text-[#14120f]">Cheaper Home Batteries Program</strong>,
          ...
          <section className="mt-10 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">How much it is worth</h2>
            <div className="mt-4 space-y-4 text-[15.5px] leading-relaxed text-[#56504a]">
              <p>
                From 1 May 2026 it works out at roughly{" "}
                <strong className="font-semibold text-[#14120f]">$252 per usable kWh</strong> for most standard home
          ...
          {/* The taper */}
          <section className="mt-10 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">The 14kWh taper</h2>
            <div className="mt-4 space-y-4 text-[15.5px] leading-relaxed text-[#56504a]">
              <p>
              ...
              <table className="w-full min-w-[440px] border-collapse text-sm">
                <thead>
                  <tr className="border-b border-[#ded8cd]">
                    <th className="pb-3 pr-4 text-left text-[11px] font-semibold uppercase tracking-widest text-[#56504a]">Capacity band</th>
                    <th className="pb-3 pr-4 text-left text-[11px] font-semibold uppercase tracking-widest text-[#56504a]">Rate applied</th>
                    <th className="pb-3 text-left text-[11px] font-semibold uppercase tracking-widest text-[#56504a]">Roughly per kWh</th>
                  </tr>
                </thead>
                <tbody className="text-[#56504a]">
                  {[
                    ...
                    <tr key={a} className="border-b border-[#f1ede4]">
                      <td className="py-3 pr-4 font-medium text-[#14120f]">{a}</td>
          ...
          {/* Worked examples */}
          <section className="mt-10 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">Worked examples</h2>
            ...
            <div className="mt-6 overflow-x-auto">
              <table className="w-full min-w-[440px] border-collapse text-sm">
                <thead>
                  <tr className="border-b border-[#ded8cd]">
                    <th className="pb-3 pr-4 text-left text-[11px] font-semibold uppercase tracking-widest text-[#56504a]">Battery size</th>
                    <th className="pb-3 pr-4 text-left text-[11px] font-semibold uppercase tracking-widest text-[#56504a]">Approx. rebate</th>
                    <th className="pb-3 text-left text-[11px] font-semibold uppercase tracking-widest text-[#56504a]">How it stacks up</th>
                  </tr>
                </thead>
                <tbody className="text-[#56504a]">
                  {[
          ...
          {/* Worth it */}
          <section className="mt-10 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">Is it worth it after the rebate?</h2>
            <div className="mt-4 space-y-4 text-[15.5px] leading-relaxed text-[#56504a]">
              <p>
          ...
          {/* Where to get it */}
          <section className="mt-10 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">Getting a quote with the rebate applied</h2>
            <div className="mt-4 space-y-4 text-[15.5px] leading-relaxed text-[#56504a]">
              <p>
                Any accredited installer applies the federal discount for you. Through Refer Labs,{" "}
                <Link href="/apollo-energy-group" className="font-semibold text-[#007a95] hover:underline">
                  Apollo Energy Group
                </Link>{" "}
              ...
              <ul className="mt-4 space-y-2">
                {[
                  ...
                  <li key={p} className="flex items-start gap-2.5 text-sm text-[#14120f]">
          ...
          {/* FAQ */}
          <section className="mt-12 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">Frequently asked questions</h2>
          ...
          <section className="mt-12 border-t border-[#ded8cd] pt-8">
            <h2 className="text-xs font-bold uppercase tracking-[0.12em] text-[#56504a]">More on home batteries</h2>
            <ul className="mt-3 flex flex-wrap gap-x-5 gap-y-2 text-sm">
              <li><Link href="/solar-and-battery-package-australia" className="font-semibold text-[#007a95] hover:underline">Buying solar and a battery together</Link></li>
              <li><Link href="/tesla-powerwall-alternatives-australia" className="font-semibold text-[#007a95] hover:underline">Powerwall alternatives</Link></li>
              <li><Link href="/home-battery-blackout-backup-australia" className="font-semibold text-[#007a95] hover:underline">Will it run the house in a blackout?</Link></li>
              <li><Link href="/home-battery-installer-sydney" className="text-[#56504a] hover:text-[#007a95] hover:underline">Installers in Sydney</Link></li>
              <li><Link href="/deals" className="text-[#56504a] hover:text-[#007a95] hover:underline">All current offers</Link></li>
            </ul>
          </section>
