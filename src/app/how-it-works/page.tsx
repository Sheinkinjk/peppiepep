    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#04101a] via-[#081820] to-[#020508] text-slate-50">
      ...
      <main className="relative mx-auto max-w-6xl px-5 sm:px-8 lg:px-12 pb-24 pt-16">
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-3">
              90-Day Pilot <span className="text-cyan-400">Structure</span>
            </h2>
          </div>

          <div className="space-y-4 max-w-4xl mx-auto">
            {/* Week 1 */}
            <div className="rounded-2xl border border-cyan-500/20 bg-gradient-to-r from-cyan-500/10 via-white/[0.03] to-transparent p-6 sm:p-8">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-xl bg-cyan-500/20 border border-cyan-500/30 flex items-center justify-center flex-shrink-0">
                  <span className="text-cyan-300 font-black text-sm">W1</span>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Market &amp; Messaging Alignment</h3>
            ...
            {/* Week 2-3 */}
            <div className="rounded-2xl border border-emerald-500/20 bg-gradient-to-r from-emerald-500/10 via-white/[0.03] to-transparent p-6 sm:p-8">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-xl bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center flex-shrink-0">
                  <span className="text-emerald-300 font-black text-sm">W2-3</span>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Build Target Lists + Partner Angles</h3>
                  <p className="text-slate-300 text-sm leading-relaxed">
            ...
            {/* Week 4-12 */}
            <div className="rounded-2xl border border-purple-500/20 bg-gradient-to-r from-purple-500/10 via-white/[0.03] to-transparent p-6 sm:p-8">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-xl bg-purple-500/20 border border-purple-500/30 flex items-center justify-center flex-shrink-0">
                  <span className="text-purple-300 font-black text-sm">W4-12</span>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Outreach + Meetings + Closing Support</h3>
                  <p className="text-slate-300 text-sm leading-relaxed">
            ...
            {/* Ongoing */}
            <div className="rounded-2xl border border-amber-500/20 bg-gradient-to-r from-amber-500/10 via-white/[0.03] to-transparent p-6 sm:p-8">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-xl bg-amber-500/20 border border-amber-500/30 flex items-center justify-center flex-shrink-0">
                  <ClipboardList className="h-5 w-5 text-amber-300" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Weekly Reporting Cadence</h3>
                  <p className="text-slate-300 text-sm leading-relaxed">
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-3">
              What You <span className="text-cyan-400">Receive</span>
            </h2>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
            {[
              ...
              <div key={item.label} className="flex items-start gap-4 p-5 rounded-xl border border-white/[0.08] bg-white/[0.03]">
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-3">
              What You <span className="text-cyan-400">Provide</span>
            </h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {[
              ...
              <div key={item} className="flex items-center gap-3 p-4 rounded-xl border border-white/[0.08] bg-white/[0.03]">
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-3">
              What We Do vs <span className="text-cyan-400">What You Do</span>
            </h2>
          </div>

          <div className="overflow-x-auto rounded-2xl border border-white/10 bg-white/[0.03] max-w-4xl mx-auto">
            <table className="min-w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="px-6 py-4 text-left text-xs uppercase tracking-wider text-slate-400 font-semibold">Area</th>
                  <th className="px-6 py-4 text-left text-xs uppercase tracking-wider text-cyan-400 font-semibold">Refer Labs</th>
                  <th className="px-6 py-4 text-left text-xs uppercase tracking-wider text-slate-400 font-semibold">You</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {[
                  ...
                  <tr key={row.area}>
                    ...
                    <td className="px-6 py-3.5 text-cyan-300">{row.us}</td>
