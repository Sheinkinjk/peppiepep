      ...
      <main id="main-content">
        ...
        <section className="mx-auto max-w-6xl px-5 pt-12 sm:px-8 sm:pt-16">
          <nav className="mb-7 flex items-center gap-2 text-sm text-[#8A938E]">
            ...
            <span>/</span>
            <span className="text-[#46524C]">Weight loss</span>
          </nav>
          <div className="max-w-2xl">
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#0E7C66]">
            ...
            <h1 className="mt-4 font-[family-name:var(--font-fraunces)] text-4xl font-semibold leading-[1.06] tracking-[-0.01em] text-[#16201C] sm:text-5xl">
              Weight loss in Australia: <span className="italic text-[#0E7C66]">the options, compared properly</span>
            </h1>
          ...
          <p className="mt-8 max-w-3xl rounded-xl border border-black/[0.07] bg-white px-5 py-4 text-xs leading-relaxed text-[#6B756F]">
            <span className="font-semibold text-[#46524C]">Information only.</span> Nothing in this hub is medical
        ...
        <section className="mx-auto max-w-6xl px-5 py-14 sm:px-8">
          ...
          <div className="mt-7 grid gap-4 lg:grid-cols-3">
            <div className="rounded-2xl border border-[#0E7C66]/30 bg-white p-7">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#0E7C66]">Pathway one</p>
              ...
              <div className="mt-5 space-y-2 text-sm font-semibold">
                <p><Link href="/best-weight-loss-telehealth-australia" className="text-[#0E7C66] hover:underline">Compare the providers →</Link></p>
                <p><Link href="/moshy-review" className="text-[#0E7C66] hover:underline">Read the Moshy review →</Link></p>
              </div>
            </div>
            <div className="rounded-2xl border border-black/[0.07] bg-white p-7">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#8A938E]">Pathway two</p>
              <h3 className="mt-3 font-[family-name:var(--font-fraunces)] text-xl font-semibold text-[#16201C]">
                Lifestyle programs
              </h3>
              <p className="mt-2.5 text-sm leading-relaxed text-[#6B756F]">
              ...
              <p className="mt-5 text-sm font-semibold">
                <Link href="/online-weight-loss-programs-australia" className="text-[#0E7C66] hover:underline">
                  How the program types differ →
                </Link>
              </p>
            </div>
            <div className="rounded-2xl border border-black/[0.07] bg-white p-7">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#8A938E]">Pathway three</p>
              <h3 className="mt-3 font-[family-name:var(--font-fraunces)] text-xl font-semibold text-[#16201C]">
                Your GP
              </h3>
              <p className="mt-2.5 text-sm leading-relaxed text-[#6B756F]">
              ...
              <p className="mt-5 text-sm font-semibold">
                <Link href="/moshy-vs-gp" className="text-[#0E7C66] hover:underline">Telehealth vs GP, compared →</Link>
              </p>
            </div>
          </div>
            ...
            <div className="mt-7 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {guides.map((g) => (
                <Link
                  key={g.href}
                  href={g.href}
                  className="group rounded-xl border border-black/[0.07] bg-white p-5 transition-all hover:-translate-y-0.5 hover:border-[#0E7C66]/40"
                >
