      ...
      <ConsumerShell>
        <main id="main-content" className="mx-auto max-w-3xl px-5 pb-24 pt-12 sm:px-8 sm:pt-16">
          ...
          <section className="mt-12 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">The verdict</h2>
          ...
          <section className="mt-10 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">The credentials</h2>
          ...
          {/* Their claims */}
          <section className="mt-10 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">Apollo&apos;s own figures</h2>
            <div className="mt-4 space-y-4 text-[15.5px] leading-relaxed text-[#56504a]">
              <p>
          ...
          {/* Who it suits */}
          <section className="mt-10 border-t border-[#ded8cd] pt-10">
            <h2 className="text-2xl font-bold text-[#14120f]">Who it suits, and who it does not</h2>
            <div className="mt-4 space-y-4 text-[15.5px] leading-relaxed text-[#56504a]">
              <p>
          ...
          <section className="mt-10 border-t border-[#ded8cd] pt-10">
            ...
            <div className="mt-4 space-y-4 text-[15.5px] leading-relaxed text-[#56504a]">
              ...
              <p>
                ...
                <Link href="/home-battery-rebate-australia" className="font-semibold text-[#007a95] hover:underline">
