...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  { title: "Prospa vs Lumi", href: "/compare-business-lenders/prospa-vs-lumi", category: "Business finance", kind: "Guide", keywords: "prospa vs lumi business loan compare which australia" },
  { title: "Prospa vs Moula", href: "/compare-business-lenders/prospa-vs-moula", category: "Business finance", kind: "Guide", keywords: "prospa vs moula business loan compare which australia" },
  { title: "Lumi vs Moula", href: "/compare-business-lenders/lumi-vs-moula", category: "Business finance", kind: "Guide", keywords: "lumi vs moula business loan compare which australia" },
