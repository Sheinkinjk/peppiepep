...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  // Weight loss
  { title: "Moshy review: how the service works", href: "/moshy-review", category: "Weight loss", kind: "Review", keywords: "getmoshy telehealth weight management online clinic" },
  ...
  { title: "Moshy offer & referral link", href: "/moshy", category: "Weight loss", kind: "Review", keywords: "getmoshy discount code deal sign up" },
  ...
  { title: "Mosh review & offer", href: "/moshhair", category: "Hair loss", kind: "Review", keywords: "mosh mens hair loss finasteride" },
  { title: "Dense Hair Experts", href: "/dense", category: "Hair loss", kind: "Review", keywords: "dense hair non prescription topical" },
  ...
  { title: "Carrd review", href: "/carrd", category: "Software", kind: "Review", keywords: "one page site cheap simple" },
  { title: "Durable AI review", href: "/durableai", category: "Software", kind: "Review", keywords: "ai website builder generate" },
  { title: "Butternut AI review", href: "/butternut", category: "Software", kind: "Review", keywords: "ai website builder generate" },
  { title: "Swipe Pages review", href: "/swipepages", category: "Software", kind: "Review", keywords: "landing page builder conversion" },
  ...
  { title: "beehiiv review", href: "/beehiiv", category: "Creator tools", kind: "Review", keywords: "newsletter email platform grow audience" },
  { title: "IncomeLab", href: "/incomelab", category: "Creator tools", kind: "Review", keywords: "make money ai income side hustle" },
  ...
  { title: "Apollo Peptide Sciences", href: "/apollopeptides", category: "Research peptides", kind: "Review", keywords: "apollo peptides research" },
  { title: "Ascension Peptides", href: "/ascensionpeptides", category: "Research peptides", kind: "Review", keywords: "ascension peptides research" },
  { title: "BioPeptiTech", href: "/biopeptitech", category: "Research peptides", kind: "Review", keywords: "biopeptitech peptides research" },
];
