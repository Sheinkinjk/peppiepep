...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  { title: "Acne treatment routes and costs", href: "/health-and-beauty/acne-treatment-options-and-costs-australia", category: "Health & beauty", kind: "Guide", keywords: "acne treatment australia cost gp dermatologist medicare referral" },
  { title: "Anti-ageing treatment pricing", href: "/health-and-beauty/anti-ageing-treatments-what-they-cost", category: "Health & beauty", kind: "Guide", keywords: "anti ageing treatment cost australia cosmetic clinic quote" },
  ...
  { title: "Natural skincare in Australia", href: "/health-and-beauty/natural-skincare-australia", category: "Health & beauty", kind: "Guide", keywords: "natural skincare australia certified organic aco register vegan cruelty free" },
  { title: "Skincare quiz", href: "/health-and-beauty/skincare-quiz", category: "Health & beauty", kind: "Guide", keywords: "skincare quiz routine matcher australia" },
