...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  { title: "EcoFlow vs Anker SOLIX: priced per watt-hour", href: "/ecoflow-vs-anker-solix", category: "Home & energy", kind: "Guide", keywords: "ecoflow vs anker solix comparison portable power station delta river c1000 c2000 f3800 price per wh australia" },
  { title: "Portable power stations in Australia: prices & runtimes", href: "/portable-power-station-australia", category: "Home & energy", kind: "Guide", keywords: "portable power station australia price best portable battery camping blackout backup fridge runtime ecoflow anker" },
  { title: "EcoFlow Australia: the range and what it costs", href: "/ecoflow", category: "Home & energy", kind: "Guide", keywords: "ecoflow australia price delta 3 river 3 delta pro ultra portable power station review discount" },
  { title: "Anker SOLIX Australia: the range and what it costs", href: "/anker-solix", category: "Home & energy", kind: "Guide", keywords: "anker solix australia price c300 c1000 c2000 f3800 portable power station review discount" },
  { title: "Portable vs installed home battery", href: "/portable-vs-installed-home-battery-australia", category: "Home & energy", kind: "Guide", keywords: "portable vs installed home battery australia rebate renters apartment blackout backup which is better" },
  { title: "Apollo Energy Group: home batteries & $500 off", href: "/apollo-energy-group", category: "Home & energy", kind: "Guide", keywords: "apollo energy group home battery australia solar battery rebate cheaper home batteries installer $500 discount" },
  ...
  { title: "Home battery rebate by state 2026", href: "/home-battery-rebate-by-state-australia", category: "Home & energy", kind: "Guide", keywords: "home battery rebate by state nsw victoria queensland wa sa tasmania act nt state battery incentive scheme which states 2026" },
  { title: "Virtual power plant (VPP) Australia 2026", href: "/virtual-power-plant-australia", category: "Home & energy", kind: "Guide", keywords: "virtual power plant vpp australia how payments work is it worth it home battery vpp incentive nsw join a vpp earnings warranty cycling" },
  ...
  { title: "Solar and battery packages", href: "/solar-and-battery-package-australia", category: "Home & energy", kind: "Guide", keywords: "solar and battery package australia bundle solar plus storage sizing rebate cost" },
  { title: "Tesla Powerwall alternatives", href: "/tesla-powerwall-alternatives-australia", category: "Home & energy", kind: "Guide", keywords: "tesla powerwall alternatives australia home battery vs powerwall compare best alternative" },
