...
export const picks = {
  ...
  items: [
    ...
    },
    {
      ...
      body: "Australian pet insurance with the cover, waiting periods and exclusions explained in plain English.",
      cta: "See the offer",
    },
    {
  ...
  columns: [
    {
      ...
      links: [
        { label: "Weight Loss & Telehealth", href: "/weight-loss" },
        { label: "Hair Loss Treatment", href: "/hair-loss" },
        { label: "Men's Health Telehealth", href: "/mens-health-telehealth-australia" },
        { label: "Solar & Energy", href: "/solar-and-energy" },
        { label: "Website Builders", href: "/compare/website-builders" },
